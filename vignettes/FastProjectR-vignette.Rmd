...
fp <- FastProject(expr, c("data/h.all.v5.2.symbols.gmt"), housekeeping = hkg)

## -- Create a FastProject object with a SummarizedExperiment
se <- SummarizedExperiment::SummarizedExperiment(assays = list(counts = expr))
fp <- FastProject(se, c("data/h.all.v5.2.symbols.gmt"), housekeeping = hkg) 
