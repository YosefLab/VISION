...
```{r hotspot}
vis <- runHotspot(vis, model="normal", tree=TRUE, min_gene_threshold=50, n_neighbors = 30, number_top_genes = 1326, logdata=TRUE)
```
...
```{r eval=FALSE}
# Init Hotspot
hs <- hsInit(vis, model = "normal", tree=TRUE, logdata=TRUE)
# Init Hotspot KNN
