...
## Hotspot analysis
As of version 3.0.0, we have enabled users to perform de-novo gene module identification [Hotspot](https://www.cell.com/cell-systems/fulltext/S2405-4712(21)00114-9) (DeTomaso and Yosef, _Cell Systems_ 2021) from within VISION. Users can consult the [Spatial Hotspot Vignette](spatialHotspot.html) for instructions for adding this analysis to a user report.
