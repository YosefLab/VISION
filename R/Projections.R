...
#' @param inputProjections a list of Projection objects. For each Projection, a corresponding TreeProjection
#' will be created in which the scores are based on geodesic distances instead of euclidean one
#' @param permMats a list of matrices to use as a null distribution for estimating the significance
#' of the fitted tree. These are generated by the permutation wPCA algorithm upstream
